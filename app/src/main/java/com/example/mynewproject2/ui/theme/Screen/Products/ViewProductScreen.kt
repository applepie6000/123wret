package com.example.mynewproject2.ui.theme.Screen.Products
...
import com.example.mynewproject2.Data.ProductViewModel
import com.example.mynewproject2.Models.Product
import com.example.mynewproject2.Navigation.ROUTE_UPDATE_PRODUCT

@Composable
fun PreviewScreens(navController:NavHostController) {
...
@Composable
fun view() {
    PreviewScreens(rememberNavController())
}
